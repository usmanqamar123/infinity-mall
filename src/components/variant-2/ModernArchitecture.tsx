...
const ModernArchitecture = () => {
  return (
    <section className="w-full h-full flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 py-10 md:py-14 lg:py-20">
      <div className="w-full max-w-[1280px] mx-auto flex items-center justify-center gap-8 lg:gap-16">
        <div className="relative w-full lg:w-[45%] h-[600px]">
          ...
          <div className="absolute bottom-14 -left-14 bg-[#006994] text-white flex flex-col items-start px-10 py-4 cursor-pointer">
            <i>More</i>
        ...
        <div className="w-full lg:w-[45%] flex flex-col items-start justify-start space-y-7 text-sm md:text-[15px]">
          <p className="text-[#008B8B] text-2xl italic font-normal">
            Modern Architecture
          </p>
