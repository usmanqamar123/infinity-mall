...
const ComplexConstruction = () => {
  return (
    <section className="w-full h-full flex flex-col items-center justify-center  pb-28">
      <div className="bg-gray-950 w-full flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 gap-10 p-10">
        ...
        <div className="relative w-[75%] flex items-center justify-between">
          <div className="absolute top-[54%] left-[75px] w-[86%] h-[2px] bg-white" />
