...
const Footer = () => {
  return (
    <footer className="bg-gray-950 overflow-x-clip relative w-full text-white pt-20 lg:pt-24 z-10 space-y-8 lg:space-y-16 xl:space-y-20">
      <div className="w-full max-w-[1440px] mx-auto flex flex-col lg:flex-row gap-16 text-white items-start justify-between px-6 md:px-10 xl:px-0">
        <div className="w-full lg:w-[40%] flex flex-col items-start gap-7">
          ...
          <div className="flex gap-4">
            <Link href="" target="_blank">
              <span className="group flex items-center justify-center w-10 h-10 bg-[#008B8B] rounded-full hover:bg-[#008B8B]/20 transition-all duration-300">
        ...
        <div className="w-full lg:w-[20%] flex flex-col gap-4">
          <span className="group flex items-center justify-center w-10 h-10 bg-[#008B8B] rounded ">
      ...
      <div className="w-full max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center justify-between py-8 border-t-1 border-gray-300  gap-7 px-6 md:px-10 xl:px-0">
        <span>© 2025 Infinity Mall. All rights reserved.</span>
        <span className="cursor-pointer hover:text-[#008B8B]">
          {" "}
          Terms & Conditions
        </span>
      </div>
